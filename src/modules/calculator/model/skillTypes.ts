...
export const skllTypeDspl: Record<string, { icon?: string; label: string, short?: string }> = {
  ...
  basicAtk: { icon: '/assets/game/stats/icons/basic.png', label: 'Basic Attack', short: 'Basic Atk' },
  heavyAtk: { icon: '/assets/game/stats/icons/heavy.png', label: 'Heavy Attack', short: 'Heavy Atk' },
  resonanceSkill: { icon: '/assets/game/stats/icons/skill.png', label: 'Resonance Skill', short: 'Res. Skill' },
  resonanceLiberation: { icon: '/assets/game/stats/icons/liberation.png', label: 'Resonance Liberation', short: 'Res. Liberation' },
  introSkill: { label: 'Intro Skill' },
  outroSkill: { label: 'Outro Skill' },
  echoSkill: { icon: '/assets/game/stats/icons/echo.png', label: 'Echo Skill' },
  ...
  healing: { icon: '/assets/game/stats/icons/healing.png', label: 'Healing' },
  shield: { label: 'Shield' },
