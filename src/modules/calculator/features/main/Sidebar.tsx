/*
  Author: Runor Ewhro
  Description: Renders the sidebar surface for the calculator main flow.
*/

import type { LeftPaneView } from '@/domain/entities/appState'

interface CalcSdbrPrps {
...
export function Sidebar({ activeView, isDark, onSelect }: CalcSdbrPrps) {
  return (
