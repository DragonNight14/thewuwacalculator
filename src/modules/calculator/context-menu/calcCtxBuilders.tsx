      ...
      return [
        {
          id: 'main-switch-to',
          label: 'Switch to...',
          icon: <RrwRghtLeft size="0.5rem" />,
          submenu: swtcToNtrs,
        },
        {
          id: 'main-open-pane',
          label: 'Open pane...',
          icon: <Milestone size="0.5rem" />,
          submenu: paneEntries,
        },
        {
          id: 'main-show-subhits',
          label: showSubHits ? 'Hide Sub-Hits' : 'Show Sub-Hits',
          icon: showSubHits ? <ListChvrDown size="0.5rem" /> : <ListChvrUpDo size="0.5rem" />,
      ...
      row({
        ...
        return ppndMoreMenu([
          ...
          },
          {
            ...
            icon: subHitsVis ? <ListChvrDown size="0.5rem" /> : <ListChvrUpDo size="0.5rem" />,
            onSelect: onTgglSubHit,
          },
          ...(onOpenSkllDa ? [{
            icon: <BookText size="0.5rem" />,
            id: `skill-data:${rowId}`,
